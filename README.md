...
| 向AI提问 | 直接在网页修改 |
|:---:|:---:|
| ![向AI提问](向AI提问.png) | ![直接在网页修改](直接在网页修改.png) |

| AI优化后替换原文 |
|:---:|
| ![AI优化后替换原文](AI优化后替换原文.png) |
...
右侧原文面板支持**富文本在线编辑**和**AI 段落优化**，可根据审核建议优化原文内容，修改后可下载保留原始格式的修改版 DOCX。
...
- ✨ **AI 优化原文** — 悬停原文段落即可结合审核建议生成优化版本，预览确认后替换原文
